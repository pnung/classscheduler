...
public class EditExamOnClickListener implements View.OnClickListener {
    ...
    public EditExamOnClickListener(FragmentActivity requiredActivity, Context context, TaskViewModel taskViewModel, int position) {
    ...
    public void onClick(View v) {
        ...
        View dialogView = inflater1.inflate(R.layout.dialog_edit_exam, null);

        Exam currentAssignment = (Exam) taskViewModel.getTasks().getValue().get(position);
